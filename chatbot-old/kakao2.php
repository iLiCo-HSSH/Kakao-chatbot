...
function downbus() {
    ...
    $key = 'HR15nrUmf2vUG/MNZD1cvS7KdyoGo8JxEASPTqr5iYC9dEJX9A+gCIWJBgoESxu1QuvFrzvq+js/bHDI8BF7KQ==';
...
function dust() {
    ...
    $url = 'http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMsrstnAcctoRltmMesureDnsty?serviceKey=TxRUKzRz1gXkGkLR3sOqOY%2FfYLCgTxZGFAtPyizkNWMjc9Per78%2BpjBqi4Fu0KCOKNkgUmhqFR33WihYJbDXwg%3D%3D&returnType=xml&numOfRows=1&pageNo=1&stationName=서대문구&dataTerm=DAILY&ver=1.3';
    $xml = file_get_contents($url);
    $xml = simplexml_load_string($xml);
    $dir = $xml->response->body->items->item;
